...
export function SettingsNavigation({
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-background">
      {/* Mobile: top tabs */}
      <div className="md:hidden sticky top-12 z-30 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b border-border/30">
        <div className="relative">
          ...
          <div className="overflow-x-auto no-scrollbar px-4">
            <ul className="flex gap-1.5 py-2 min-w-full">
              {items.map((item) => {
                ...
                return (
                  <li key={item.id} className="flex-shrink-0">
                    <Link
                      href={item.href}
                      className={cn(
                        'inline-flex h-7 items-center justify-center gap-1.5 px-2.5 rounded-sm',
                        'font-mono text-xs whitespace-nowrap',
                        'border transition-colors duration-0 cursor-default',
                        active
      ...
      <div className="px-6 py-8">
        <div className="max-w-5xl mx-auto md:grid md:grid-cols-[180px_1fr] gap-6">
                    ...
                    <li key={item.id}>
                      <Link
                        ...
                        className={cn(
                          ...
                          'font-mono text-xs',
                          'transition-colors duration-0 cursor-default',
                          active
